...
const Expertise = () => {
  ...
  return (
    <div className="md:py-[40px] md:mx-[100px] relative">
      <Helmet title="MH - My Skills" />
      <h3 className="text-4xl font-bold">
        My <span className="text-blue-600">Skills</span>
      </h3>
      <hr className="border-2 " />
      <div className="grid grid-cols-4 md:gap-5 md:mt-[80px]">
        <div className="flex flex-col justify-between items-center w-56 p-4 rounded-xl shadow-2xl card">
        ...
        {!active && (
          <>
            <div className="bord flex-col justify-between items-center w-56 p-4 rounded-xl shadow-2xl card">
